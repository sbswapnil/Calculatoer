...
class Calc(Tk):
    ...
    def buttons_0_9(self):
        ...
        self.button_1.grid(column=0, row=2, pady=5, sticky=N+S+E+W )
        ...
        self.button_4.grid(column=0, row=3, pady=5, sticky=N+S+E+W)
        ...
        self.button_7.grid(column=0, row=4, pady=5, sticky=N+S+E+W)
